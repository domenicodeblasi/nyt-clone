...
const MainNewsSection = ({ singleSection }) => {
    ...
    return (
        <section className="relative flex border-b-2 border-black last:border-0 md:border-b">
            <div className="md:max-w-[40%] md:pr-2 md:after:absolute md:after:w-[1px] md:after:h-[96%] md:after:bg-gray-400 md:after:top-[2%] md:after:left-[40%]">
                {singleSection.map(singleNews => {
                    const { id, title, abstract, multimedia, url, bookmark } = singleNews
                    return (
                        <div className="flex flex-col gap-2 py-4 border-b border-gray-400 last:border-0" key={id}>
                            <a href={url} title={title} className="cursor-pointer">
                                ...
                                {(singleNews === singleSection[0] && screenWidth < md) && (
                                    <ImgAndCopyright
            ...
            {(singleSection[0] && screenWidth > md) && (
