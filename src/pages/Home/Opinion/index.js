...
const Opinion = () => {
    ...
    return (
        <article className="border-b-2 border-black lg:border-b w-full py-2">
            ...
            {/* FIRST BLOCK */}
            <div className="w-full flex flex-col md:flex-row-reverse md:border-b md:border-gray-300 lg:border-0 lg:flex-col">
                ...
                <div className="w-full md:pr-2 md:mb-2 md:border-r md:border-gray-300 md:max-w-[40%] lg:max-w-full lg:border-0 lg:p-0 lg:m-0">
            ...
            {/* SECOND BLOCK */}
            <div className="w-full flex flex-col md:flex-row-reverse md:border-b md:border-gray-300 md:mt-2 lg:m-0 lg:border-0 lg:flex-col">
                ...
                {carouselOpinionsSection.map(singleOpinion => {
                    ...
                    return (
                        <a
                            ...
                            href={url}
                            title={title}
                            className="relative flex flex-col basis-full grow-0 shrink-0 p-4 mt-3 sm:basis-1/2 md:basis-1/3 lg:basis-1/2 border-r border-gray-300"
                            style={{
